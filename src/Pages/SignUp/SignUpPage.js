...
const SignUpPage = () => {
  ...
  const confirmSignUp = async (code) => {
    setLoading(true);
    try {
      await Auth.confirmSignUp(emailData, code);
      ...
      if (
        ...
        setErrorMsg("Vérifiez votre code de validation");
      }
    }
  };
  ...
  const onFormSubmit = (data) => {
    const { email, mdp: password, nom: last_name, prenom: first_name } = data;
    setEmailData(email);
    ...
    <div className="wrapper">
      {verificationModal && (
        <div className="verificationContainer">
          <div className="verifElements">
            <AiOutlineClose
              className="closeBtnModal"
              onClick={() => setVerificationModal(false)}
            />
            <p className="verifPara">
            ...
            />
            {errorMsg && <p className="paraErr0">{errorMsg}</p>}
            <button onClick={() => confirmSignUp(code)} className="verifBtn">
              Vérifier
            </button>
          </div>
        </div>
      ...
      <div className="formWrapper">
        <div className="rightPart">
          ...
          <div className="right__bottomPart">
            <p className="bottomPart__para">Vous avez déja un compte ?</p>
            <Link to="/signin">
              <button className="bottomPart__btn">Sign In</button>
            </Link>
          </div>
        </div>
        <div className="leftPart">
          <div className="formBox">
            <div className="left__topPart">
              ...
              <h3 className="left__topPart--heading">À propos de vous</h3>
            ...
            <div className="left__middlePart">
              <form className="myForm" onSubmit={handleSubmit(onFormSubmit)}>
                <div className="formLine personLine">
                  <div className="input-icons">
                    ...
                    <input
                      ...
                      placeholder="Nom"
                      className={
                        errors.nom ? "errorInput input-field" : "input-field"
                      }
                  ...
                  <div className="input-icons">
                    ...
                    <input
                      ...
                      placeholder="Prenom"
                      className={
                        errors.prenom ? "errorInput input-field" : "input-field"
                      }
                ...
                <div className="formLine">
                  <div className="input-icons">
                    ...
                    <input
                      ...
                      className={
                        errors.cmdp ? "errorInput input-field" : "input-field"
                      }
                      {...register("cmdp", {
                        required: true,
                        validate: (val) => {
                          if (watch("mdp") !== val) {
                            return "yourpasswords do no match";
                          }
                        },
                      })}
                    />
                ...
                <div className="new">
                  <p className="first">Vous avez deja un compte ?</p>
                  <Link to="/signin" style={{ textDecoration: "none" }}>
                    <p className="second">sign in</p>
                  </Link>
                </div>
              </form>
            </div>
